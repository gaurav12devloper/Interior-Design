...
export default function review() {
  return (
    <section className="flex 2xl:px-32 bg-white items-center justify-center lg:py-[5vh] md:py-[5vh] py-[2vh] w-full px-4 md:px-16 lg:px-24 flex-col gap-10" id="Review">
    <div className="flex flex-col items-center justify-between w-full px-2 md:flex-row ">
      <h3 className="flex items-start justify-start max-w-xl gap-5 text-3xl font-bold text-center md:text-left lg:max-w-xl md:max-w-md md:text-3xl lg:text-4xl font-poppins">
    ...
    <div className="grid items-center grid-cols-1 gap-5 p-2 overflow-x-auto md:grid-cols-2 lg:grid-cols-3 md:flex-row ">
      {reviews.map((rev) => {
        ...
        return (
          <div
            key={id}
            className="flex hover:border-2 flex-col px-5 py-6 rounded-sm shadow-md md:px-12 shadow-gray-300 bg-gray-50 "
          >
